...
export const Results = ({
  ...
  return (
    <div className={"my-12"}>
      <h1 className="text-lg-neon-white text-center m-auto text-3xl mt-32">
...
export function getResults(prioritizeOptions: prioritizeOption[]) {
  ...
  const sortedSelectedOptions = Object.keys(numberOfSelectedOptions).sort(
    function (a, b) {
  ...
  const highestNumberOfSelections = new Set(
    sortedNumberOfSelections.slice(0, 3)
  );
